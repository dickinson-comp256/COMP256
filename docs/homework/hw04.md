...
1. Explain how your program from the previous question would change if it were to set the value of `MM[15]` to be true if either `MM[16]` or `MM[17]` has a true value, otherwise `MM[15]` should be set to a false value.
