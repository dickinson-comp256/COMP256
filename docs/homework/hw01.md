...
1. Watch the video linked on the course web page for this class and for the first lab.  Name the three switching technologies that have been used in the creation of electronic computers in the order in which they were used.
...
1. Fill in the blanks below using "open" or "closed" to create true statements:  
  ...
  - An N-type transistor acts like a(n) `______________` switch when its gate has a positive voltage (i.e. logical 1).
  - A P-type transistor acts like a(n) `______________` switch when its gate is grounded (i.e. logical 0).
...
1. Consider the Boolean function F implemented by the circuit shown below:
  ...
  - Give a logic expression for the Boolean function F.
  - Give a truth table for the Boolean function F.
...
1. Consider the Boolean function expressed as a logic expression shown below:  

  ![Logic Expression](hw01-expression.jpeg)

    - Give a truth table for this Boolean function.
    - Draw a logic circuit that implements this Boolean function.

1. Use LogicSim to build the circuit from the previous question. Control the inputs to the circuit using DIP switches and show the output using an LED. Simulate your circuit to confirm that it properly implements the function. Include a screen shot of the circuit in your homework submission.

1. Consider the Boolean function represented as a truth table shown below:

  ![Truth Table](hw01-truthtable.jpeg)

  - Give a logic expression for this Boolean expression.
  - Draw a logic circuit that implements this Boolean expression.
